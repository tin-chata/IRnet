...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--data_path', type=str, help='data path', default="../../data/mysemQL/")
    arg_parser.add_argument('--input_path', type=str, help='predicted logical form', default='../../data/mysemQL/dev.json')
