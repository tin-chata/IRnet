...
class SCHEMA:
    def __init__(self, table_file):
        ...
        self.table_dict = SCHEMA.get_table_dict(table_file)
...
def load_dataset(data_path, table_path):
    tables = SCHEMA(table_path).table_dict
    data = JSON.load(data_path)
    for d in data:
        # TODO: remove these fields in data and move to tables
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--output', type=str, help='output data', default="../../dataset/processed/train.json")
